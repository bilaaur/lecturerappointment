...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editTextConfirmPassword = findViewById(R.id.editTextConfirmPassword); // For re-enter password
        ...
        buttonRegister.setOnClickListener(v -> {
            ...
            if (!email.endsWith("@student.president.ac.id")) {
                editTextEmail.setError("Email must end with @student.president.ac.id!");
                editTextEmail.requestFocus();
                return;
            }
            if (password.isEmpty()) {
            ...
            createUser.addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    Intent openLogin = new Intent(getApplicationContext(), FacultyActivity.class);
                    startActivity(openLogin);
                } else {
                    Log.e("RegistError", "Registration error: " + task.getException().getMessage());
